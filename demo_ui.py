"""
Pogadane UI Demo - Identical to Real GUI (No Processing)
============================================================
This demo replicates the exact GUI from gui_flet.py but with mocked processing.
Dependencies: flet only
"""
